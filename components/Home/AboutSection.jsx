      ...
      <div className="w-full h-full bg-gradient-to-r from-indigo-800/50 relative to-transparent py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center-gap-4">
          <div className="col-span-1 lg:col-span-6 px-8 space-y-6">
            <h3 className="text-3xl w-fit pb-2 text-[#f1f1f1] ">
              Tentang Kami
            </h3>
            <div className="pb-6 px-2 leading-relaxed space-y-3">
              <p className="text-[#404040] antialiased text-lg leading-relaxed">
            ...
            <Link href="about">
              <button className="py-3 px-7 border border-white/60 antialiased text-[#e7e7e7] hover:text-[#e7e7e7]  hover:bg-gradient-to-br from-indigo-400 to-indigo-600 font-semibold rounded hover:border-indigo-500 bg-none transition-all duration-200">
                Read More ..
              </button>
            </Link>
          </div>
